...
DEFAULT_APPEARANCE: dict[str, Any] = {
    ...
    "title_font_family": "",
    "font_family": "",
    # 左侧导航栏(Explorer)与右侧目录栏(TOC)字体:空串=跟随主题默认字体
...
def _public_view(cfg: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "explorer_font_family": cfg.get("explorer_font_family", ""),
        "toc_font_family": cfg.get("toc_font_family", ""),
...
def save_appearance(data: dict[str, Any]) -> dict[str, Any]:
    ...
    cfg: dict[str, Any] = {
        ...
        "explorer_font_family": str(data.get("explorer_font_family", ""))[:200],
        "toc_font_family": str(data.get("toc_font_family", ""))[:200],
